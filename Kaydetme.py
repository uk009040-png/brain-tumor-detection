...
if not os.path.exists(test_folder):
    print("The specified test folder could not be found.")
    exit()
...
for filename in os.listdir(test_folder):
    ...
    if file_path.lower().endswith(('.jpg', '.jpeg', '.png')):
        try:
            ...
            print(f'{filename} - Predicted Class Sınıf: {sınıf}')
        except Exception as img_err:
            print(f"{filename} - Error occurred while processing the image: {img_err}")